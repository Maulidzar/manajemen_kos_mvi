...
import com.example.kosmvvm.viewmodel.DashboardIntent
...
class DashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            dashboardViewModel.state.collect { state ->
                ...
                kamarAdapter.submitList(state.kamarList)
            }
        }
        ...
        binding.searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                dashboardViewModel.dispatch(DashboardIntent.SearchKamar(newText ?: ""))
                return true
            }
        })
    ...
    private fun updateCombinedFilter() {
        ...
        dashboardViewModel.dispatch(DashboardIntent.ApplyFilter(filter, butuhMaintenance))
    }
    ...
    private fun showDeleteConfirmationDialog(data: KamarWithPenghuni) {
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Hapus") { _, _ ->
                dashboardViewModel.dispatch(DashboardIntent.DeleteKamar(data.kamar, data.penghuni))
